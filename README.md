...
<img src="https://github.com/rushdi-rusho/variational_manifold_speech_MRI/blob/main/images/Video-1-pseudo3D.gif" width=40% height=40%> Fig. 3: Proposed variational manifold method (synchronized in time)
